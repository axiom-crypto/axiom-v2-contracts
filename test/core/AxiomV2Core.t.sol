...
contract AxiomV2CoreTest is AxiomTestBase {
    bytes public updateOldProofData;
    bytes public updateHistoricalProofData;
    ...
    function setUp() public virtual {
        ...
        // Valid SNARK proof of the chain of block headers between blocks in range `[0xf99000, 0xf993ff]`.
        updateOldProofData = _readCoreUpdateOld1ProofData();
        // Valid SNARK proof of the chain of block headers between blocks in range `[0x000000, 0x01ffff]`.
        updateHistoricalProofData = _readCoreUpdateHistoricalProofData();
    }
    ...
    function test_updateOld() public {
        ...
        axiom.updateOld(bytes32(hex"00"), uint32(0), updateOldProofData);
    }
    ...
    function test_updateOld_blockhash_fail() public {
        ...
        axiom.updateOld(bytes32(hex"00"), uint32(1), updateOldProofData);
    }
    ...
    function test_updateOld_proof_fail() public {
        ...
        updateOldProofData[21] = bytes1(0x53);
    ...
    function test_updateOld_startBlockNumber_fail() public {
        ...
        updateOldProofData[539] = bytes1(0x01);
    ...
    function test_updateOld_numFinal_fail() public {
        ...
        updateOldProofData[542] = bytes1(0x94);
        updateOldProofData[543] = bytes1(0x00);
    ...
    function test_updateHistorical() public {
        ...
        string memory data = vm.readFile("test/data/core/mock/updateHistorical_0.dat");
    ...
    function test_updateHistorical_proof_fail() public {
        ...
        updateHistoricalProofData[3063] = bytes1(0xec);
    ...
    function test_updateHistorical_startBlockNumber_fail() public {
        ...
        updateHistoricalProofData[539] = bytes1(0x01);
    ...
    function test_updateHistorical_numFinal_fail() public {
        ...
        updateHistoricalProofData[542] = bytes1(0xef);
