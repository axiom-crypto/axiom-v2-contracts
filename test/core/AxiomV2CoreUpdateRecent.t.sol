...
contract AxiomV2CoreUpdateRecent is AxiomTestBase {
    ...
    bytes public updateRecent1024ProofData;
    bytes public updateRecent128ProofData;
    ...
    function setUp() public {
        ...
        updateRecent1024ProofData = _readCoreUpdateOld1ProofData();

        // Valid SNARK for blocks in `[0xf99000, 0xf9907f]`
        updateRecent128ProofData = _readCoreUpdateOld2ProofData();
    }
    ...
    function test_updateRecent_128() public {
        ...
        vm.prank(prover);
        axiom.updateRecent(updateRecent128ProofData);
    }
    ...
    function test_updateRecent_1024_proof_fail() public {
        ...
        require(updateRecent1024ProofData[21] != bytes1(0x53), "choose a different random byte");
        updateRecent1024ProofData[21] = bytes1(0x53);
    ...
    function test_updateRecent_1024_proof_malformed_uint256() public {
        ...
        updateRecent1024ProofData[4] = bytes1(0x10);
    ...
    function test_updateRecent_1024_numFinal_fail() public {
        ...
        updateRecent1024ProofData[542] = bytes1(0x94);
        updateRecent1024ProofData[543] = bytes1(0x00);
    ...
    function test_updateRecent_1024_startBlockNumber_fail() public {
        ...
        updateRecent1024ProofData[539] = bytes1(0x01);
    ...
    function test_updateRecent_1024_endhash_fail() public {
        ...
        updateRecent1024ProofData[511] = bytes1(0x0e);
