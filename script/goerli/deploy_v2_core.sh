...
forge script script/goerli/AxiomV2CoreDeploy.s.sol:AxiomV2CoreDeploy --sender $SENDER_ADDRESS --keystore $KEYSTORE_PATH --rpc-url $GOERLI_RPC_URL --force --verify --etherscan-api-key $ETHERSCAN_API_KEY -vvvv --broadcast 
